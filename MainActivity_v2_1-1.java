...
public class MainActivity extends Activity {
    ...
    private void buildUi() {
        ...
        TextView sub = tv("카카오톡 메시지·스크린샷도 일정으로 바로 저장 · 기본 1시간 전 알림", 14, false);
    ...
    private ParsedSchedule parseScheduleText(String text) {
        ...
        // 1) 제목: [공사랑FC 일정 안내] 같은 안내 제목을 최우선
        ...
        if (p.title.isEmpty()) p.title = "카카오톡 일정";

        // 2) 날짜: 9/12(토), 9/12, 9월 12일, 내일/모레
        ...
        for (String raw : lines) {
            ...
            if (!(line.contains("일정") || line.contains("게임") || line.contains("경기") ||
                  line.contains("훈련") || line.contains("레슨") || line.contains("예약"))) continue;
